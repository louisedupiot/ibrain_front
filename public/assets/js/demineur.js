        ...
        // ... et si la case est une bombe
            ...
            for (i = 0; i < terrain.length; i++) {
                for (j = 0; j < terrain.length; j++)
                    if (terrain[i][j] == MINE) {
                        document.getElementById(i + "" + j).style.backgroundColor = "#F8A6C5";
                        document.getElementById(i + "" + j).innerHTML = "<img src=../assets/images/bomb_logo.png  width='30px' height='30px'>"
                    }
            }
